...
<html>
    <head>
        <title>Customer Register | Gym</title>
    ...
    <body>
       ...
       <div class="credentials-Container">   
            <h4 class="form-header ">Create Account Customer</h4>
            <div>
            ...
            <div class="link-container">
                <a href="loginCustomer.php" class="credentials-link">Already have an account? Login</a>              
